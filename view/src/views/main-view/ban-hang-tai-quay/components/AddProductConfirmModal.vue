  ...
  >
    <div v-if="product">
      <div style="display: flex; gap: 12px; margin-bottom: 12px; padding-bottom: 8px; border-bottom: 1px solid #e5e5e5">
        <img
          v-if="product.anhSanPham?.[0]"
          :src="product.anhSanPham[0]"
        ...
        <div style="flex: 1">
            ...
            <div v-if="product.tenMauSac">
              ...
              <div style="display: flex; align-items: center; gap: 8px; margin-top: 4px">
                <div
                  ...
                  :style="{ backgroundColor: product.maMau }"
                  :title="product.maMau"
                />
                <div>
          ...
          <div v-if="product.giaTriGiamGia && product.giaTriGiamGia > 0" style="margin-bottom: 0">
            ...
            <div style="font-weight: 600; color: #f5222d; font-size: 14px">
              {{ formatCurrency(product.giaBan * (1 - product.giaTriGiamGia / 100)) }}
            </div>
          </div>
      ...
      <div>
        <label style="display: block; margin-bottom: 6px; font-weight: 600; font-size: 13px">
          Số Lượng (Tồn kho: {{ product.soLuong || 0 }})
        </label>
        <a-input-number
