...
import localeInvoice from '@/views/main-view/quan-ly-hoa-don/locale/en-US'
import localeLichLamViec from '@/views/main-view/lich-lam-viec/locale/en-US'
...
export default {
  ...
  'menu.quan-ly-giam-gia.dot-giam-gia': 'Discount Campaigns',
  'menu.quan-ly-giam-gia.dot-giam-gia.create': 'Create Discount Campaign',
  'menu.quan-ly-giam-gia.dot-giam-gia.edit': 'Edit Discount Campaign',
  'menu.quan-ly-giam-gia.phieu-giam-gia': 'Coupons',
  'menu.quan-ly-giam-gia.phieu-giam-gia.create': 'Create Coupon',
  'menu.quan-ly-giam-gia.phieu-giam-gia.edit': 'Edit Coupon',
