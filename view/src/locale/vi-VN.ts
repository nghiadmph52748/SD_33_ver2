...
export default {
  ...
  'menu.hoa-don-chi-tiet': 'Chi tiết hoá đơn',
  ...
  'menu.quan-ly-giam-gia.dot-giam-gia.edit': 'Chỉnh sửa đợt giảm giá',
  'menu.quan-ly-giam-gia.phieu-giam-gia': 'Phiếu Giảm Giá',
  'menu.quan-ly-giam-gia.phieu-giam-gia.create': 'Tạo phiếu giảm giá',
  'menu.quan-ly-giam-gia.phieu-giam-gia.edit': 'Chỉnh sửa phiếu giảm giá',
