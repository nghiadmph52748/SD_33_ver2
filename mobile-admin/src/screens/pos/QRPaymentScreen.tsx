      ...
      <View style={styles.welcomeWrapper}>
        <Card style={styles.welcomeCard}>
          <Card.Content>
            ...
            <Text style={styles.welcomeTitle}>Chào mừng đến màn hình VietQR</Text>
            <Text style={styles.welcomeSubtitle}>
              Hãy thao tác trên POS để mở QR, màn hình này sẽ tự hiển thị giỏ hàng và mã VietQR ngay khi có tín hiệu.
            </Text>
            <View style={styles.welcomeSteps}>
              <Text style={styles.welcomeStep}>① Thêm sản phẩm vào giỏ tại quầy.</Text>
              <Text style={styles.welcomeStep}>② Nhấn “Mở trên mobile” trong thẻ VietQR.</Text>
      ...
      {hasQrCode ? (
        ...
        <Card style={styles.qrPlaceholderCard}>
          <Card.Content style={styles.qrPlaceholderContent}>
            <Text style={styles.placeholderTitle}>Chưa hiển thị VietQR</Text>
