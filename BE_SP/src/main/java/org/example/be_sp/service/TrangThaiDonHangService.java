...
public class TrangThaiDonHangService extends GenericCrudService<TrangThaiDonHang, Integer, TrangThaiDonHangResponse, TrangThaiDonHangRequest> {
    ...
    public TrangThaiDonHangService(Class<TrangThaiDonHang> entity,
            Class<TrangThaiDonHangResponse> trangThaiDonHangResponseClass,
            Class<TrangThaiDonHangRequest> trangThaiDonHangRequestClass,
            JpaRepository<TrangThaiDonHang, Integer> repository) {
